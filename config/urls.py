...
urlpatterns += [
    ...
    url(
        r"^blog/manage/posts/create/$",
        o_views.ManageCreatePost.as_view(),
        name="manage_post_create",
    ),
    url(
        r"^blog/manage/posts/(?P<post_pk>\d+)/update/$",
        o_views.ManageUpdatePost.as_view(),
