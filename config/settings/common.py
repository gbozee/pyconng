...
ROOT_DIR = environ.Path(__file__) - 3  # (python_nigeria/config/settings/common.py - 3 = python_nigeria/)
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'python_nigeria.contrib.sites.migrations'
}
...
ADMINS = (
    ("""The Python Nigeria Community""", 'hello@pycon.ng'),
)
...
RECAPTCHA_PUBLIC_KEY = env("RECAPTCHA_PUBLIC_KEY", default="6LcXCVAUAAAAAJ91TSqGxTa3klWZkVczL_guXHMN")
RECAPTCHA_PRIVATE_KEY = env("RECAPTCHA_PRIVATE_KEY",default='6LcXCVAUAAAAAFOQeqopAJH6_MSPGzMGmnnQUM3G')
